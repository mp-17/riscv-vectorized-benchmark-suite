...
_MMR_f64   _ps256_min_norm_pos      = vreinterpret_v_i64m1_f64m1(_256_min_norm_pos); // MOIMFELD: Introduced reinterpret
...
_MMR_MASK_i64 invalid_mask = _MM_VFLE_f64(x,_MM_SET_f64(0.0f,gvl),gvl);
  ...
  imm0 = vreinterpret_v_u64m1_i64m1(_MM_SRL_i64(vreinterpret_v_f64m1_u64m1(x), vreinterpret_v_i64m1_u64m1(_MM_SET_i64(52,gvl)), gvl)); // MOIMFELD: Introduced reinterpret

  /* keep only the fractional part */
  // _x_i = _MM_AND_i64((_MMR_i64)x, _256_inv_mant_mask, gvl);
  _x_i = _MM_AND_i64(vreinterpret_v_f64m1_i64m1(x), _256_inv_mant_mask, gvl); // MOIMFELD: Introduced reinterpret
  // _x_i = _MM_OR_i64(_x_i, (_MMR_i64)_ps256_0p5, gvl);
  _x_i = _MM_OR_i64(_x_i, vreinterpret_v_f64m1_i64m1(_ps256_0p5), gvl); // MOIMFELD: Introduced reinterpret
  // x= (_MMR_f64)_x_i;
  x= vreinterpret_v_i64m1_f64m1(_x_i); // MOIMFELD: Introduced reinterpret
